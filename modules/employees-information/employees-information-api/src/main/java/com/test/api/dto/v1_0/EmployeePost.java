...
public class EmployeePost implements Serializable {
	...
	public static EmployeePost toDTO(String json) {
		return ObjectMapperUtil.readValue(EmployeePost.class, json);
	}

	public static EmployeePost unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(EmployeePost.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.test.api.dto.v1_0.EmployeePost",
		name = "x-class-name"
	)
