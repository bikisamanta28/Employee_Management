...
import com.test.api.client.serdes.v1_0.EmployeePostSerDes;
 ...
 */
@Generated("")
public class EmployeePost implements Cloneable, Serializable {

	public static EmployeePost toDTO(String json) {
		return EmployeePostSerDes.toDTO(json);
	}
	...
	public void setSiteId(
		UnsafeSupplier<String, Exception> siteIdUnsafeSupplier) {
	...
	@Override
	public EmployeePost clone() throws CloneNotSupportedException {
		return (EmployeePost)super.clone();
	}
	...
	public boolean equals(Object object) {
		...
		return Objects.equals(toString(), employeePost.toString());
	}
	...
	public String toString() {
		return EmployeePostSerDes.toJSON(this);
	}
