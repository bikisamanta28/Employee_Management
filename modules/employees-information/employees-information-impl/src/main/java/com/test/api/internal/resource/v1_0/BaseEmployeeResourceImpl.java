...
public abstract class BaseEmployeeResourceImpl implements EmployeeResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/employees-information/v1.0/employee/{employeeId}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/employee/{employeeId}")
