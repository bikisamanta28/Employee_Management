...
import com.liferay.revisited.employee.model.EmployeeModel;
...
public class EmployeeModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"name", Types.VARCHAR}, {"adress", Types.VARCHAR},
		{"phoneNo", Types.BIGINT}, {"salary", Types.BIGINT},
		{"emailAdress", Types.VARCHAR}, {"doj", Types.TIMESTAMP},
		{"dol", Types.TIMESTAMP}
	};
	...
	public static final String ORDER_BY_SQL =
		" ORDER BY ls_Employee.salary ASC";
	...
	static {
		...
		attributeGetterFunctions.put("adress", Employee::getAdress);
		attributeSetterBiConsumers.put(
			"adress", (BiConsumer<Employee, String>)Employee::setAdress);
		attributeGetterFunctions.put("phoneNo", Employee::getPhoneNo);
		attributeSetterBiConsumers.put(
			"phoneNo", (BiConsumer<Employee, Long>)Employee::setPhoneNo);
		attributeGetterFunctions.put("salary", Employee::getSalary);
		attributeSetterBiConsumers.put(
			"salary", (BiConsumer<Employee, Long>)Employee::setSalary);
		attributeGetterFunctions.put("emailAdress", Employee::getEmailAdress);
		attributeSetterBiConsumers.put(
			"emailAdress",
			(BiConsumer<Employee, String>)Employee::setEmailAdress);
	...
	public Object clone() {
		...
		employeeImpl.setAdress(getAdress());
		employeeImpl.setPhoneNo(getPhoneNo());
		employeeImpl.setSalary(getSalary());
		employeeImpl.setEmailAdress(getEmailAdress());
	...
	public Employee cloneWithOriginalValues() {
		...
		employeeImpl.setAdress(this.<String>getColumnOriginalValue("adress"));
		employeeImpl.setPhoneNo(this.<Long>getColumnOriginalValue("phoneNo"));
		employeeImpl.setSalary(this.<Long>getColumnOriginalValue("salary"));
		employeeImpl.setEmailAdress(
			this.<String>getColumnOriginalValue("emailAdress"));
	...
	public CacheModel<Employee> toCacheModel() {
		...
		employeeCacheModel.adress = getAdress();

		String adress = employeeCacheModel.adress;

		if ((adress != null) && (adress.length() == 0)) {
			employeeCacheModel.adress = null;
		}
		...
		employeeCacheModel.emailAdress = getEmailAdress();

		String emailAdress = employeeCacheModel.emailAdress;

		if ((emailAdress != null) && (emailAdress.length() == 0)) {
			employeeCacheModel.emailAdress = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("adress", _adress);
		_columnOriginalValues.put("phoneNo", _phoneNo);
		_columnOriginalValues.put("salary", _salary);
		_columnOriginalValues.put("emailAdress", _emailAdress);
	...
	static {
		...
		columnBitmasks.put("adress", 512L);

		columnBitmasks.put("phoneNo", 1024L);

		columnBitmasks.put("salary", 2048L);

		columnBitmasks.put("emailAdress", 4096L);

		columnBitmasks.put("doj", 8192L);

		columnBitmasks.put("dol", 16384L);
